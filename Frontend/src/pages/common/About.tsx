        ...
        <div className="w-full max-w-7xl px-6 py-12 space-y-16">
          ...
          >
            ...
            >
              <div className="w-full md:w-1/2">
                ...
                <p className="text-lg">
                  At Skillora, our mission is to create a thriving ecosystem
            ...
            >
              <div className="w-full md:w-1/2">
                ...
                <p className="text-lg">
                  ...
                  everyone. By leveraging the power of technology, Skillora is
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="rounded-2xl shadow-md">
                <CardContent className="p-6 space-y-3">
                  ...
                  <p>
                    With chat, notifications, and live updates, Skillora keeps
          ...
          >
            ...
            <p>
              ...
              client in search of talent, Skillora is your home.
            </p>
            <Button
              onClick={() => navigate("/")}
              size="lg"
